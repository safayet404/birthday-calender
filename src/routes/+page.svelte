<script lang="ts">
	...
	function getYears() {
	  ...
	  return Array.from({ length: currentYear - 1905 + 1 }, (_, i) => 1905 + i);
	}
  </script>
  ...
  <div class="container mx-auto mt-10">
	...
	<div class="grid grid-cols-3 gap-10">
	  ...
	  <div class="flex flex-col">
		...
		<select id="month" bind:value={month} class="mt-2 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
	  ...
	  <div class="flex flex-col">
		...
		<select id="year" bind:value={year} class="mt-2 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
